...
namespace Debugger
{
    ...
    public static partial class DebuggerExtensions
    {
        ...
        [DebugMethod("goto.fullscreen")]
        [DebugMethod("fullscreen")]
        ...
        [DebugMethod(alias: "log")]
        [DebugMethod(alias: "print")]
        ...
        /// </summary>
        /// <param name="fileName"></param>
        [DebugMethod(alias: "system.openLink")]
        [DebugMethod(alias: "system.startProcess")]
